...
import 'package:tapmaan/widgets/bottom_scrollview.dart';
...
class _LocationScreenState extends State<LocationScreen> {
  ...
  void updateUi(Weather weatherModel) {
    setState(() {
      try {
        model = weatherModel;
                    ...
                    child: TextField(
                      ...
                      onSubmitted: (searchedCity) async {
                        if (searchedCity.isNotEmpty) {
                          Weather _model = Weather.fromJson(
                  ...
                  Material(
                    ...
                    child: Container(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () async {
                          Weather model = Weather.fromJson(
                              await GetWeatherData(false).getLocationData());
                          updateUi(model);
                        },
                      ),
                    ),
